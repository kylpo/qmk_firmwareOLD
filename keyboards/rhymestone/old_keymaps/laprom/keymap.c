...
enum combos { AEI, ASI, AEF, OTSPC, ONSPC, MTSPC };

#define M_CMD_CLICK LGUI(KC_MS_BTN1)

const uint16_t PROGMEM aei_combo[]   = {KC_A, KC_E, COMBO_END};
const uint16_t PROGMEM asi_combo[]   = {KC_L, KC_S, COMBO_END};
const uint16_t PROGMEM aef_combo[]   = {KC_A, KC_E, KC_I, COMBO_END};
const uint16_t PROGMEM otspc_combo[] = {KC_T, KC_SPACE, COMBO_END};
const uint16_t PROGMEM onspc_combo[] = {KC_O, KC_T, COMBO_END};
const uint16_t PROGMEM mtspc_combo[] = {KC_O, KC_T, KC_SPACE, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {[AEI] = COMBO(aei_combo, KC_V), [ASI] = COMBO(asi_combo, KC_X), [AEF] = COMBO(aef_combo, KC_Z), [OTSPC] = COMBO(otspc_combo, KC_K), [ONSPC] = COMBO(onspc_combo, KC_J), [MTSPC] = COMBO(mtspc_combo, KC_Q)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(  // TODO: remove RESETs when done coding
                       //,---------------------------------------------------------------------------------------------------.
        RESET /*XXXXXXX*/, KC_L, KC_S, KC_H, KC_X, KC_J, KC_R, KC_N, KC_C, RESET /*XXXXXXX*/,
        //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
        KC_G, KC_A, KC_E, KC_I, KC_V, KC_K, KC_O, KC_T, KC_SPACE, KC_Y,
        //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
        KC_LCTL, KC_P, KC_U, KC_F, KC_Z, KC_Q, KC_M, KC_D, KC_W, KC_LCMD,
        //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
        KC_DOT, XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, R4_C6, XXXXXXX, XXXXXXX, XXXXXXX, KC_B
        //,---------------------------------------------------------------------------------------------------.
        ),
