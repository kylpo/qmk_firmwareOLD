...
const uint16_t PROGMEM z_combo[]      = {KC_A, KC_E, KC_O, COMBO_END};
const uint16_t PROGMEM q_combo[]      = {KC_I, KC_T, KC_SPC_UND, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(  // TODO: remove RESETs when done coding
        ...
        //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
        KC_V, KC_A, KC_E, KC_O, KC_G, KC_Y, KC_I, KC_T, KC_SPC_UND, KC_K,
        //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
